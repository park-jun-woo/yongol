...
//ff:checked llm=yongol-gen hash=9693ca26
package main
...
import (
	...
	"github.com/example/zenflow_try01/internal/middleware"
	"github.com/example/zenflow_try01/internal/service"
	...
	"os"
	"time"
	infraauth "github.com/example/zenflow_try01/internal/infra/auth"
)

func main() {
	logLevel := parseLogLevel(os.Getenv("LOG_LEVEL"))
	sensitiveKeys := buildSensitiveKeys([]string{"password_hash", "token_hash"})
