...
//ff:what ListWorkflows — List workflows for the current user's org
//ff:checked llm=yongol-gen hash=ccb5211c
package service
...
func (server *Server) ListWorkflows(ctx context.Context, request api.ListWorkflowsRequestObject) (api.ListWorkflowsResponseObject, error) {
	...
	if err != nil {
		...
		return api.ListWorkflows403JSONResponse{Error: "Forbidden", Code: "forbidden"}, nil
	}
