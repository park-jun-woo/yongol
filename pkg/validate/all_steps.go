...
func allSteps() []step {
	return []step{
		...
		{Name: "openapi_ssac", Kinds: []yongol.SSOTKind{yongol.KindOpenAPI, yongol.KindSSaC}, Run: openapi_ssac.Run, DomainAware: true},
		{Name: "hurl_openapi", Kinds: []yongol.SSOTKind{yongol.KindScenario, yongol.KindOpenAPI}, Run: hurl_openapi.Run, DomainMerged: true},
		...
		{Name: "openapi_manifest", Kinds: []yongol.SSOTKind{yongol.KindOpenAPI, yongol.KindConfig}, Run: openapi_manifest.Run, DomainMerged: true},
		...
		{Name: "stml_openapi", Kinds: []yongol.SSOTKind{yongol.KindOpenAPI}, Run: stml_openapi.Run, DomainAware: true},
		...
		{Name: "domain_security", Kinds: []yongol.SSOTKind{yongol.KindConfig, yongol.KindOpenAPI}, Run: domain_security.Run, DomainAware: true},
		{Name: "design_manifest", Kinds: []yongol.SSOTKind{yongol.KindConfig}, Run: design_manifest.Run},
		{Name: "features_openapi", Kinds: []yongol.SSOTKind{yongol.KindFeatures, yongol.KindOpenAPI}, Run: features_openapi.Run, DomainAware: true},
