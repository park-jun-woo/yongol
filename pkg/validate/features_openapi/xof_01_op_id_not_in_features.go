...
//ff:what XOF-01 — OpenAPI operationId가 features에 없으면 WARNING
...
// xof01OpIDNotInFeatures validates XOF-01: every OpenAPI operationId should
// be listed in features.yaml. WARNING level because intentional omission is allowed.
func xof01OpIDNotInFeatures(fs *yongol.Fullstack) []diagnostic.Diagnostic {
	...
	for opID := range g.Lookup["OpenAPI.operationId"] {
		...
		diags = append(diags, diagnostic.Diagnostic{
			...
			Advice:  "Add this operationId to features.yaml, or ignore if intentionally omitted",
		})
	}
	return diags
}
