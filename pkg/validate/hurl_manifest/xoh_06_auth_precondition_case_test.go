...
//ff:what runXoh06AuthPrecondition — TestXoh06AuthPrecondition table-driven 개별 케이스 검증
...
func runXoh06AuthPrecondition(t *testing.T, c TestXoh06AuthPreconditionCase) {
	t.Helper()
	diags := xoh06AuthPrecondition(c.fs)
