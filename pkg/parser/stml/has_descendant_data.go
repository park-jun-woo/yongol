...
//ff:what 하위 요소에 data-fetch·data-action·data-link 속성이 있는지 재귀 확인
package stml

import "golang.org/x/net/html"

// hasDescendantData checks if any descendant has a data-fetch, data-action
// or data-link attribute.
