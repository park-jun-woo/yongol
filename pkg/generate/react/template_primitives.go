...
// Primitive template constants for shadcn-like UI components emitted under
// src/components/ui/. Each constant is a backtick string; grouped here to
// keep components_ui.go focused on the file-write loop (Q3 exemption via
// var-only file).
