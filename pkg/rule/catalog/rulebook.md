...
total is the count of distinct rule IDs in the tables below — **382 rules across
60 prefixes**. This includes 27 retired rules (Deprecated section); the
**active** subset (rows in the non-deprecated tables) is **355**.
